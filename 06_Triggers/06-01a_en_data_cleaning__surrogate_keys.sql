...
--SELECT * FROM customers ;
-- force the primary key violation
UPDATE customers SET cust_id = 1012 WHERE cust_id = 1011 ;
-- the new customer must have not 1012 but 1013 as cust_id
INSERT INTO customers 
...
--================================================================================
/*
                           The second problem with surrogate keys
    
    When a surrogate key gets values from a sequence, we must take care
        of situation when that surrogate key appears as a foreign key 
        (in a child table)
    
    Example: 
    When entering an invoice, we cannot know in advance its customer "cust_id", but only
       "cust_name"
...
--================================================================================
--    Finally, we'll create a function to be used in inserts into the child tables 
---------------------------------------------------------------
CREATE OR REPLACE PACKAGE pac_sales 
AS
...
--================================================================================
--                      Population of the table "products"
----------------------------------------------------------------------------------
DELETE FROM products ;
INSERT INTO products VALUES (1, 'Produs 1','buc', 'Tigari', .24)  ;
INSERT INTO products VALUES (2, 'Produs 2','kg', 'Bere', 0.12)  ;
INSERT INTO products VALUES (3, 'Produs 3','kg', 'Bere', 0.24)  ;
INSERT INTO products VALUES (4, 'Produs 4','l', 'Dulciuri', 0.12)  ;
INSERT INTO products VALUES (5, 'Produs 5','buc', 'Tigari', .24)  ;
INSERT INTO products VALUES (6, 'Produs 6','p250g', 'Cafea', .24)  ;
COMMIT ;
