...
CREATE TABLE RESERVATION (
  ...
  Reserved_Room_Type NUMBER(10)
    CONSTRAINT FK_ROOM_TYPES_REZ REFERENCES ROOM_TYPES(ROOM_TYPE)
...
BEGIN
  ...
  -- insert ROOMS
   ...
   INSERT INTO SPECIAL_OFFERS (Room_Type, From__Date, Until__Date,Special_Price_Per_Night)
    VALUES (1, TO_DATE('12/12/2017', 'dd/mm/yyyy'),TO_DATE('23/12/2017', 'dd/mm/yyyy'),50);
   INSERT INTO SPECIAL_OFFERS (Room_Type, From__Date, Until__Date,Special_Price_Per_Night)
    VALUES (1, TO_DATE('10/04/2017', 'dd/mm/yyyy'),TO_DATE('10/05/2017', 'dd/mm/yyyy'),75);
   INSERT INTO SPECIAL_OFFERS (Room_Type, From__Date, Until__Date,Special_Price_Per_Night)
    VALUES (3, TO_DATE('12/12/2017', 'dd/mm/yyyy'),TO_DATE('23/12/2017', 'dd/mm/yyyy'),50);
   INSERT INTO SPECIAL_OFFERS (Room_Type, From__Date, Until__Date,Special_Price_Per_Night)
    VALUES (3, TO_DATE('10/04/2017', 'dd/mm/yyyy'),TO_DATE('10/07/2017', 'dd/mm/yyyy'),75);  
    ...
    -- insert RESERVATION
    INSERT INTO RESERVATION (Reservation_Id, Reservation_Timestamp, Cust_Id, Reserved_Room_Type, Reserved_From, Reserved_Until)
    ...
    INSERT INTO RESERVATION (Reservation_Id, Reservation_Timestamp, Cust_Id, Reserved_Room_Type, Reserved_From, Reserved_Until)
    VALUES (4, SYSDATE, 2, 1, TO_DATE('20/05/2017', 'dd/mm/yyyy'), TO_DATE('25/05/2017', 'dd/mm/yyyy'));
    
    INSERT INTO RESERVATION (Reservation_Id, Reservation_Timestamp, Cust_Id, Reserved_Room_Type, Reserved_From, Reserved_Until)
    VALUES (5, SYSDATE, 3, 1, TO_DATE('16/05/2017', 'dd/mm/yyyy'), TO_DATE('21/05/2017', 'dd/mm/yyyy'));
    
    INSERT INTO RESERVATION (Reservation_Id, Reservation_Timestamp, Cust_Id, Reserved_Room_Type, Reserved_From, Reserved_Until)
    VALUES (6, SYSDATE, 4, 2, TO_DATE('12/05/2017', 'dd/mm/yyyy'), TO_DATE('17/05/2017', 'dd/mm/yyyy'));
